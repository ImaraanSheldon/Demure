<template>
    <div class="container-fluid bg-light-brown text-dark" id="admin">
        <h1 class="text-brown">ADMIN</h1>
        <div class="container tab-div bg-white">
          <h2 class="text-dark">Users</h2>
          <button class="add btn btn-brown" data-bs-toggle="modal" data-bs-target="#addUserModal">
            <i class="fa-solid fa-user-plus"></i>
          </button>
          <table class="table table-light-grey">
            <thead class="text-grey bg-light-grey">
              <tr id="prod-row">
            ...
            <tbody v-if="users" class="text-dark">
              <tr v-for="user in users" :key="user.userID" id="prod-row">
                ...
                <td>{{ user.emailAdd }}</td>
                <td class="btns">
                  <button @click="editUser(user.userID)" class="btn-edit btn btn-dark" data-bs-toggle="modal" data-bs-target="#editUserModal">
                    <i class="fa-solid fa-user-pen"></i>
                  </button>
                  <button @click="delUser(user.userID)" class="btn-del btn btn-dark">
        ...
        <div class="container tab-div bg-white">
          ...
          <button class="add btn btn-brown" type="button" data-bs-toggle="modal" data-bs-target="#addproductModal">
          ...
          <table class="table table-light-grey">
            ...
            <tbody v-if="products" class="text-dark">
              <tr v-for="product in products" :key="product.prodID" id="prod-row">
                ...
                <td class="btns">
                  <button @click="editBtn(product.prodID)" class="btn-edit btn btn-dark" data-bs-toggle="modal"
                    data-bs-target="#productModal"><i class="fa-regular fa-pen-to-square"></i></button>
                  <button @click="delProd(product.prodID)" class="btn-del btn btn-dark"><i class="fa-solid fa-trash"></i></button>
                </td>
              </tr>
            </tbody>
            <tbody v-else>
